        ...
        {!end ? (
          ...
          <>
            <Image
              ...
              className={styles.image}
            />
            <p>Para saber mais, assista o vídeo abaixo.</p>

            {/* Ajustar tamanho do iframe */}
            <iframe
              width="320"
              height="180"
              src="https://www.youtube-nocookie.com/embed/7WetVUOSfm4"
            ...
            <p>
              Agradecemos a sua participação! Busque hábitos saudáveis,
              lembre-se de que você é muito importante e deve se cuidar!
            </p>

            <Link href="https://pebmed.com.br/brain-fog-no-pos-covid-19-uma-epidemia/">
              <Button
                title="Leia um artigo sobre Nuvem Mental"
                onClick={() => {
                  handleGA({
